...
console.log("-----método 6: getBookAutor-----");
console.log(`Autor de los libros de usuario 1: ${usuario1.getBookAutor()}`);
console.log(`Autor de los libros de usuario 2: ${usuario2.getBookAutor()}`);
console.log("");

console.log("-----método 7: getMascotas-----");
console.log(`Mascotas de usuario 1: ${usuario1.getMascotas()}`);
console.log(`Mascotas de usuario 2: ${usuario2.getMascotas()}`);
console.log("");
